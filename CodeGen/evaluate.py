...
from config import *
from data import (get_human_eval_plus, get_human_eval_plus_hash, get_mbpp_plus, get_mbpp_plus_hash, load_solutions,)
from data.mbpp import mbpp_serialize_inputs
from data.utils import CACHE_DIR
from eval import (PASS, compatible_eval_result, estimate_pass_at_k, untrusted_check,)
...
####Main method to generate and run the code
def evaluate(
    dataset: str,
