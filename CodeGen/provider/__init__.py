...
def make_model(
    ...
    if backend == "vllm":
        ...
        from provider.openai import OpenAIChatDecoder
        ...
        from provider.anthropic import AnthropicDecoder
        ...
        from provider.google import GeminiDecoder
        ...
        from provider.bedrock import BedrockDecoder
        ...
        from provider.gptqmodel import GPTQModelDecoder
